  ...
  return (
    <div className="">
      ...
      <div className="bg-gray-900">
        <div className="w-11/12 mx-auto min-h-screen  text-white p-6">
          {/* Header Section */}
          <div className="text-center mb-10">
            <h1 className="text-4xl font-extrabold mb-2 textred-400">
              GameHub Community
            </h1>
            ...
            <button
              ...
              className="mt-6 bg-red-600 hover:bg-red-700 px-6 py-2 rounded-full text-sm font-semibold transition"
            >
          ...
          {showForm && (
            ...
            >
              ...
              <input
                ...
                className="w-full mb-3 p-2 rounded bg-gray-700 text-white outline-none focus:ring-2 focus:ring-red-500"
              />
              <input
                type="text"
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {posts.map((post) => (
              ...
              >
                ...
                <button className="mt-4 bg-red-600 hover:bg-red-700 px-4 py-2 rounded-full text-sm font-semibold">
                  Join Discussion
                </button>
              </div>
            ))}
          ...
          <div className="text-center mt-30 text-gray-400 text-sm">
            <Link to="/" className="btn bg-red-600 border-red-600 text-white">
              <FaBackward />
              Back To Home
            </Link>
          </div>
